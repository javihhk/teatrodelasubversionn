...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Mostrar la pantalla de juego al hacer clic en "Play"
    btnPlay.addEventListener('click', () => {
        ...
        audio.muted = false; //Reproducir la música al hacer clic
        audio.play();
    });
        ...
        prenda.addEventListener('click', () => {
            ...
            if (categoria.includes('gorrita')) {
                ...
                if (prendaPeluca) {
                    ...
                    mostrarMensaje('Ese lazo te hace el rostro demasiado femenino');  // Este es el mensaje que aparecerá siempre que se ponga la gorra con la camisa de hombre
                } else {
    ...
    if (textonombre.textContent !== 'Claud Cahun') {
        textonombre.textContent = 'Desconocido';
            ...
            if (categoria.includes('peluca')) {
                ...
                // Si ya hay gorra, aseguramos que la gorra esté encima
                if (prendaGorra) {
                    prendaGorra.style.zIndex = '2'; // Gorra encima de la peluca
                }
                if (!prendaCamisa && !prendaZapatos && !prendaGorra && !prendaMascara && !prendaRopaSeñora) {
...
if (categoria.includes('camisa') || categoria.includes('zapatos') || categoria.includes('gorrita') || categoria.includes('mascara') || categoria.includes('peluca')) {
